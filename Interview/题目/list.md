...
4. 为什么最终选用了 SSE，相比于其他的他有哪些优势。
5. 不用 SSE 你会做哪些性能优化
6. SSE 到底优化了哪些指标，有没有具体衡量
7. 不用 SSE 还是用短轮询，你会怎么去优化，用尽所有优化手段
8. 截图服务背景
9. html2canvas 为什么能提高性能，怎么就优化了。
10. 限流是怎么做的
11. 如何做到高并发。
12. 除了限流还能有哪些手段，我理解这个是异步的，怎么尽可能的优化，所有手段
13. 还能怎么去做更好的优化
14. 服务端能拿到 UA 的信息吗
15. 截图服务的 QPS 是多少
16. 了解 SSR 和 CSG 吗
17. 有一个场景，怎么根据用户的输入（比如用户在 PC、手机端），然后分发去不同的页面
18. 题目
